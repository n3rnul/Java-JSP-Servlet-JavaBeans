...
@WebServlet("/Isa003_003")
public class Isa003_003 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// 勤務形態の取得
		int workstyle = Integer.parseInt(request.getParameter("style"));
		...
		if (startTime < endTime) {
			...
			request.getRequestDispatcher("./isa003_003.jsp").forward(request, response);
		} else {
